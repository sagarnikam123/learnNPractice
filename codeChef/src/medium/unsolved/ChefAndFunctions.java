...
Chef defines a function root(i, x) which gives the greatest integer less than or equal to the i th root of a positive integer x .
For example, root(2, 4) is 2 and root(2, 2) is 1 .
