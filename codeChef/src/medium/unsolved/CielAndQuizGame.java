/**
	...
	Therefore, Ciel decides to choose K problems maximizing the probability that participants will
	solve exactly K-1 problems correctly.
	
	The N problems are numbered from 1 to N.
	Ciel assumes, the problem i will be solved correctly with probability Pi% for each i, and 
	these are statistically independent of each other.
...
In the fourth case, there are multiple solutions.
Any 5 distinct intergers from 1 to 10 will be accepted.
