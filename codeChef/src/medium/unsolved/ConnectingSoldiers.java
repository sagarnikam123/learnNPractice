/**
	...
	If there is no soldier to his left, he is connected to the left tower.
	The same is the case with right side.
...
In the 3rd case, the minimum length of wire required is 5, for any of the permutations {1,2} or {2,1},
so length 4 is not sufficient.

In the 4th case, for the permutation {1, 2, 3, 4, 5} we need the maximum length of the wire = 20.
So minimum possible unused wire length = 25 - 20 = 5.
