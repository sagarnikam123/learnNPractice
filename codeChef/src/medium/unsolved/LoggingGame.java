/**
	...
	Logging can be a very mundane job, but Alice and Bob have devised a game to help them
	...
	exactly 1 meter is fine). In other words, non-integer lengths are allowed.
	Alice makes the first cut, and the first logger who cannot make a legal cut loses.
