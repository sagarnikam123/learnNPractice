/**
	...
	to be placed. Johnny needs to write a program that, given the description of the words in a paragraph, is able to
	...
	Each test case has the following form:
	    ...
	    The next lines contain the description of the queries, one query in a line. Each query can be of one of
	...
	Output
	For each test case, the first line of output should contain the string "Case #T:" where T should be replaced by
...
In the following description of the second exemplary test case, we use the digit i to denote a character of the ith word.
Note that each line can hold at most 6 characters. Initially, the paragraph has the following form:
1
22222
3333
44444
