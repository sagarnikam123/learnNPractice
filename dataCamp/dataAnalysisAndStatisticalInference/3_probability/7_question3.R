...
2	The typical length of a streak, as measured by the median, is 0.
3	The IQR of the distribution is 1.
4	Streak lengths of 3 and 4 are unusually high compared to the rest of the distribution.

Answer - 1	The distribution of Kobe's streaks is unimodal and left skewed.