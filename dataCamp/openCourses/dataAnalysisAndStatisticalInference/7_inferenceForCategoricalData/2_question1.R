...
#######################################################################################################################
#	
#	First, read the official press release for the poll, conducted by WIN-Gallup International.
#	
...
Answer - 4	A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries
