...
#######################################################################################################################
#
#   You are given a string which comprises of lower case alphabets (a-z), upper case alphabets (A-Z), numbers, (0-9)
#   and special characters like !,-.; etc.
#   You are supposed to find out which character occurs the maximum number of times and the number of its occurrence,
#   in the given string. If two characters occur equal number of times, you have to output the character
#   with the lower ASCII value.
