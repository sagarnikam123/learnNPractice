...
public class CardStackApp {
	...
	public static void main(String[] args) {
		...
		app.stackCards();
		System.out.println("Cards inserted in stack");
		System.out.println();

		app.unstackCards();
		System.out.println();
		System.out.println("All Cards removed from stack");
		System.out.println();

		// restack cards
		app.stackCards();
		System.out.println("Restackd cards");
		System.out.println();

		// how many cards are on the deck
		System.out.print("how many cards are on the deck?-> ");
		app.desckSize();

		// do we have queen of hearts in the deck
		System.out.print("do we have queen of hearts in the deck?-> ");
		app.containsCard("Queen of Hearts");

		// do we have a joker
		System.out.print("do we have a joker?-> ");
		app.containsCard("Joker");

		// go to the king of diamonds
		System.out.print("go to the king of diamonds-> ");
		app.goToCard("King of Diamonds");

		// now how many cards are on the deck
		System.out.print("now how many cards are on the deck-> ");
		app.desckSize();
	}
