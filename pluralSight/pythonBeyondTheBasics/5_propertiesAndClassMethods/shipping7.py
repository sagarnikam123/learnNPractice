...
class ShippingContainer7:
    ...
    def __init__(self, owner_code, length_ft,   contents):
        ...
        self.bic = self._make_bic_code(
                    ...
                    serial=ShippingContainer7._get_next_serial()
                    )

    @property
    def volume_ft3(self):
        return ShippingContainer7.HEIGHT_FT * ShippingContainer7.WIDTH_FT * self.length_ft

class RefrigeratedShippingContainer(ShippingContainer7):
