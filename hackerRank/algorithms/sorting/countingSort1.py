...
#   comparing the elements to one another. A comparison sort algorithm cannot beat n * log(n) (worst-case) running
#   time, since n * log(n) represents the minimum number of comparisons needed to know where to place each element.
...
#   make it possible to sort lists even in linear time. These challenges will cover Counting Sort, a fast way to sort
#   lists where the elements have a small number of possible values, such as integers within a certain range.
...
#   3 89 30 27 79 46 96 27 32 18 21 92 69 81 40 40 34 68 78 24 87 42 69 23 41 78 22 6 90 99 89 50 30 20 1 43 3 70 95
