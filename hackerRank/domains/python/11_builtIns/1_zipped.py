...
#   zip([iterable, ...])
#
#   This function returns a list of tuples. The ith tuple contains the th element from each of the argument
#   sequences or iterables. If the argument sequences are of unequal lengths, then the returned list is truncated
...
#   Avarage = Sum of scores obtained in all subjects by a student/ Total number of subjects
#
