...
#   and <style>...</style>). The data argument is the text content of HTML.
#
#   from HTMLParser import HTMLParser
#
#   class MyHTMLParser(HTMLParser):
...
#
#   Output Format
#   Print the single-line comments, multi-line comments and the data in order of their
#   occurrence from top to bottom in the snippet. Format the answers as explained in the problem statement.
#
#   Sample Input
#   4
