...
#   Handling Exceptions
#
#   The statements try and except can be used to handle selected exceptions. A try statement may have more than one
#       except clause to specify handlers for different exceptions.
#   #Code
#   try:
#       print 1/0
