...
#   the integers in set A and dislike all the integers in set B. Your initial happiness is 0. For each i integer
#   in the array, if i E A you add 1 to your happiness. If i E B you add -1 to your happiness.
